...
List of sanity checks. i want to provide this, what would be a neat way of showing them? so i have molecules like cam_camkii_t306p must be zero because t306 cannot p if camkii subunit bound to camkii, for example...should i have a table, or a list?
