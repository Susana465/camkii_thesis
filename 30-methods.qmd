...
Molecules in the model can have various binding sites, or none. For example, Ca2+ and PP1 are modelled as reactants that can interact with other molecules, but they themselves don't have binding sites. On the other hand, CaM, CaMKII and NMDAR all have different binding sites (ADD FIGURE), additionally, CaMKII is modelled as a dodecamer, with two rings of six subunits stacked on top of each other (ADD FIGURE). Each subunit is modelled to have the following possible states:
