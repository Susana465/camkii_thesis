...
Next, we examine CaM–CaMKII binding (@cam-camkii-binding), focusing on how CaMKII's open conformation of subunits stabilises over time. Out of the 720 CaMKII subunits released, a total of 104 molecules remain in the open conformation (camkii_open), at 100 seconds. Camkii_open represent the total population of CaMKII subunits that are structurally in their open state. To determine how many of these open subunits are simultaneously bound to CaM, we refer to the pink trace in @cam-camkii-binding, which indicates that 79 subunits are CaM-bound by the end of the simulation. This suggests that approximately 75% of the open CaMKII subunits are being stabilised in this state through CaM binding up until that point. 
...
![Description NEEDED. _For reproducibility, this figure was obtained from plotting "run_2025-04-03_08-45-21_seed_2._"](40-results-figures\WT\cam-camkii-binding.png){#cam-camkii-binding fig-pos='H' fig-scap="Ratio of CaMKII bound to CaM"}

now link into camkii binding to nmdar, not needing cam for this, and futher [hosphorylation.]
