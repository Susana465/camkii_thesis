...
CaMKII is a critical synaptic protein that constitutes up to 2% of total brain protein. This kinase is a large holoenzyme consisting of 10/12 subunits. At its basal state, CaMKII is found mostly in its closed, inactive state through the binding of a regulatory segment to its substrate binding site [FIGURE]. A key feature of CaMKII in the context of long-term potentiation (LTP) is its ability to undergo autophosphorylation at threonine 286 (T286). This autophosphorylation event allows CaMKII to remain in an autonomous, calcium/calmodulin-independent active state, allowing its activity to persist even after the initial calcium stimulus has passed. 
