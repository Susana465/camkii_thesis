...
Multiple molecular and cellular mechanisms contribute to induction, expression, and maintenance of LTP. Induction of E-LTP occurs when the intracellular concentration of calcium inside the postsynaptic cell exceeds a critical threshold. The transient influx of Ca²⁺ into the cell is facilitated by NMDA receptors, which are ionotropic, non-selective cationic glutamate receptors essential for the rapid regulation of synaptic plasticity.
