...
It is LTP that depends on NMDAR activation where much research has been done [@malenka2004LTPLTDEmbarrassment; @nicoll2017BriefHistoryLongTerm], as it is a well-characterized form of LTP that directly links synaptic activity to molecular signaling pathways crucial for learning and memory. In this project we mainly focus on this type of LTP. We know that CaMKII activity is key for induction and maintenance of this form of LTP, and that CaMKII and NMDAR binding has been shown to maintain LTP [REFERENCE]; however, the exact mechanisms behind this remain to be ellucidated. There is substancial evidence in support of the hypothesis that CaMKII/NMDAR complex maintains LTP is substantial, however, it is not agreed on yet the time course and persistence of the CaMKII/NMDAR complex after LTP induction (REFERENCES NEED TO LOOK THIS UP GOOD TO TEST.) Likewise, _Additional work is also required to elucidate how the CaMKII/NMDAR complex produces the structural growth of the synapse that underlies late LTP._
