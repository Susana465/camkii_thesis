...
CaMKII is a critical synaptic protein that constitutes up to 2% of total brain protein. This kinase is a large holoenzyme consisting of 10/12 subunits. At its basal state, CaMKII is found mostly in its locked and closed, inactive state through the binding of a regulatory segment to its substrate binding site [FIGURE]. A key characteristic of CaMKII for its function in LTP is its ability to autophosphorylate at its T286 site. This autophosphorylation capacity has been shown to enable CaMKII to remain in a calcium–calmodulin-independent "autonomous" state, allowing its activity to persist even after the initial calcium stimulus has passed. 
